  ...
  <section class="syndrome-main-area">
    <div class="container"> 
      <div class="section-title">
        <h1 style="color:rgb(36, 6, 157);"><?php echo $category ?> Doctors </h1>
      ...
      <?php
            ...
            $sel= "SELECT * FROM tbldoctor WHERE Specialization = (SELECT ID FROM tblspecialization WHERE Specialization='$category')";
