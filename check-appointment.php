...
$("#doctorlist").html(data);
    ...
    <body id="top">
        ...
        <a href="Home.php" class="home_btn"><button  type="button" > Home </button></a>
...
$sql="SELECT * from tblappointment WHERE Email='$Email'  AND (AppointmentNumber like '$sdata%' || Name like '$sdata%' || MobileNumber like '$sdata%' ||  Email like '$sdata%') ";
