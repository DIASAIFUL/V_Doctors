...
$sql="Insert Into tbldoctor(FullName,MobileNumber,Email,Details,Address,VisitingHours,Image,Specialization,Password)Values(:fname,:mobno,:email,:details,:address,:visitinghoure,:upload_dir,:sid,:password)";
...
<head>
	...
	<title>Doctors - Signup Page</title>
...
<body class="simple-page">
	...
	<h4 class="form-title m-b-xl text-center">Sign Up With Your Doctor Account</h4>
	<form action="" method="post" enctype="multipart/form-data" >
		...
		<div class="form-group">
			<input id="mobno" type="text" class="form-control" placeholder="Qualifications" name="details"  required="true">
		</div>

		<div class="form-group">
			<input id="mobno" type="text" class="form-control" placeholder="Chamber Name & Address" name="address"  required="true">
		</div>
		<div class="form-group">
			<input id="mobno" type="text" class="form-control" placeholder="Visiting Hour" name="visitinghoure"  required="true">
		</div>
		<div class="form-group">     
